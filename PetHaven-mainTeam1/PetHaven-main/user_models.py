...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///petheaven92.db'
...
def insert_initial_data():
    if Service.query.count() == 0:
        ...
        for service in services_data:
            db.session.add(Service(service_id=service[0], service_name=service[1], service_description=service[2]))
        db.session.commit()
